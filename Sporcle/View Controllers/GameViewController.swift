...
final class GameViewController: UIViewController {
    ...
    @IBOutlet private var keywordTextField: UITextField!

    @IBOutlet private var scoreLabel: UILabel!

    @IBOutlet private var timeLabel: UILabel!

    @IBOutlet private var startResetButton: UIButton!

    @IBOutlet private var controlsViewBottomConstraint: NSLayoutConstraint!
    ...
    @IBAction private func startResetButtonClicked(_: UIButton) {
    ...
    private func showMessage(forError _: Error,
